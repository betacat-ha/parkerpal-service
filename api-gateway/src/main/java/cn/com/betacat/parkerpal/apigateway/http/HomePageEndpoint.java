...
//    private StatisticUtils statistics;
    ...
    public ResResult<HomePageResp.RevenueStatisticsDTO> getStatistics(@RequestBody HomePageReq.Query1DTO dto) {
        // 统计临保收益
    ...
    public ResResult<HomePageResp.ParkingSpaceStatisticsDTO> parkingSpaceStatistics(@RequestBody HomePageReq.Query1DTO dto) {
        // 响应数据转换
//        return ResResult.success(HomePageConverter.INSTANCE.toDto(statistics.parkingSpaceStatistics(dto.getUserId())));
        return null; // TODO
    }
}
