...
import com.sp.cjgc.common.constants.AppConstants;
...
import com.sp.cjgc.common.mapper.ParkCollectCouponsMapper;
...
import com.sp.cjgc.core.utils.order.ChargeRulesUtil;
import com.sp.cjgc.core.utils.order.OrderUtils;
import com.sp.cjgc.core.utils.order.TemporaryUtil;
...
public class ParkCollectCouponsServiceImpl
    ...
    public synchronized Map<String, Object> assignedNumber(String userId) {
        ...
        params.put(AppConstants.KEY_NAME_1, assignedNumber - countTotal.intValue());
        params.put(AppConstants.KEY_NAME_2, assignedNumber - countTotal.intValue() > 0 ? "1" : "0");
        params.put(AppConstants.KEY_NAME_3, users.getUserName());
        // 返回剩余可发放的车位数量
        return params;
    }
