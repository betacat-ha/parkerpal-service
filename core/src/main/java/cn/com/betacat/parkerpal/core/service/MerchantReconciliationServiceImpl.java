...
import cn.com.betacat.parkerpal.apicontracts.mapper.MerchantReconciliationMapper;
...
public class MerchantReconciliationServiceImpl
    ...
    public void createOrUpdateEntity(ParkCollectCoupons parkCollectCoupons) {
        ...
        double toHours = temporaryService.parseDurationToHours(parkCollectCoupons.getTotalDuration());
        // 判断是否存在数据
