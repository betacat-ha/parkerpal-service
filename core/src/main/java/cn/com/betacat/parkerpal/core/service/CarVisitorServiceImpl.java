...
import cn.com.betacat.parkerpal.apicontracts.mapper.CarVisitorMapper;
 ...
 */
@Service
public class CarVisitorServiceImpl extends ServiceImpl<CarVisitorMapper, CarVisitor> implements
    CarVisitorService {
    ...
    private void dataValidation(String mainlandLicensePlates) {
        ...
        if (Objects.nonNull(visitor))
            throw new BizException(
                RespEnum.FAILURE.getCode(), "车牌号码为【" + mainlandLicensePlates + "】的访客车已登记。");
    }
}
