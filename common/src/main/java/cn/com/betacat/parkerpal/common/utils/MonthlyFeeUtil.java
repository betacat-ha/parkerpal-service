...
public final class MonthlyFeeUtil {
...
//        return dailyFree.setScale(2, RoundingMode.HALF_UP).toString();
     ...
     * @return 月保费用
     */
    private static String currentYear(BigDecimal dailyRate, String free, LocalDateTime startTime,
     ...
     * @return 月保费用
     */
    private static String noCurrentYear(BigDecimal dailyRate, String free, LocalDateTime startTime,
        LocalDateTime endTime) {
        // 获取开始时间的月份、日期、以及当前月份的天数
